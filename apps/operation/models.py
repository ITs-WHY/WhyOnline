...
class Banner(BaseModel):
    ...
    image = models.ImageField(upload_to="banner/%Y/%m", max_length=500, verbose_name='轮播图')
...
class CourseComment(BaseModel):
    ...
    course = models.ForeignKey(Course,on_delete=models.CASCADE,verbose_name='课程1')
    comments = models.CharField(default='',max_length=500,verbose_name='评论')
